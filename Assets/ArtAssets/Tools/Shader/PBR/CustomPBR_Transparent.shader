Shader "PBR/CustomPBR_Transparent" {
	...
	Properties {
        ...
        /*边缘发光*/
        [Header(OutLight)]
        [Toggle(USE_OUT_LIGHT)] _UseOutLight("边缘发光效果", Float) = 0
        _OutLightStrengh("边缘发光强度",Range(0, 5)) = 1
        _OutLightPow("边缘发光渐变",Range(0.01, 5)) = 1
        _OutLightColor("边缘光颜色",Color) = (1,1,1,1)
	...
	SubShader {
		...
		Pass {
			...
			Tags {"Queue" = "Transparent" "RenderType" = "Transparent" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "LightMode" = "UniversalForward"}
            ...
            #pragma shader_feature __ USE_OUT_LIGHT
