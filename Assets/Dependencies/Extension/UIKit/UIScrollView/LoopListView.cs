...
public class LoopListView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    System.Func<LoopListView, int, LoopListItem> mOnGetItemByIndex;
    ...
    public System.Action<LoopListView, LoopListItem> mOnSnapItemFinished = null;
    public System.Action<LoopListView, LoopListItem> mOnSnapNearestChanged = null;
    ...
    private LoopListItem lastOnTachItem;

    public LoopListItem LastOnTachItem
    {
        get { return lastOnTachItem; }
        set { lastOnTachItem = value; }
    }
    ...
    */
    public void InitListView(int itemTotalCount,
        System.Func<LoopListView, int, LoopListItem> onGetItemByIndex,
    ...
    */
    ...
    public void DoActionForEachShownItem(System.Action<LoopListItem, object> action, object param)
    {
        if (action == null)
        {
            return;
    ...
    */
    ...
    void InitItemPool()
    {
        foreach (ItemPrefabConfData data in mItemPrefabDataList)
        {
            ...
            if (mItemPoolDict.TryGetValue(prefabName, out ItemPool temp))
            {
    ...
    public virtual void OnDrag(PointerEventData eventData)
    {
        ...
        if (lastOnTachItem != null) {
            lastOnTachItem.gameObject.transform.DOLocalMove(new Vector3(0, lastOnTachItem.gameObject.transform.localPosition.y, lastOnTachItem.gameObject.transform.localPosition.z), 0.2f);
            lastOnTachItem = null;
        }
    }
